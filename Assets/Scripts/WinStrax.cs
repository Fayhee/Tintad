...
public class WinStrax : MonoBehaviour
{
    ...
    public TMP_Text PlayerAddress_Text, Balance_Text;
    public Text PopupPanel_Text;
    public TMP_InputField PlayerMnemonic;
   ...
   private void Awake()
    ...
    public void InitializeApi_ButtonCall()
    {
    ...
    public IEnumerator RefreshBalance()
    {
        decimal balance = -1;
    ...
    public void RefreshBalance_ButtonCall()
    {
        this.StartCoroutine(RefreshBalance());
    }

    public IEnumerator SendTx_ButtonCall()
    {
        Unity3dClient client = new Unity3dClient(ApiUrl);
